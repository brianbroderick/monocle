defmodule Regressions.I88AnchorLinksInsideParensTest do
  ...
  # describe "parens" do
    ...
    test "parens: normal case" do
      result = Monocle.as_html!( "([text](link))" )
