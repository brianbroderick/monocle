defmodule Monocle.Block do

  # import Tools.Tracer
  use Monocle.Types
  import Monocle.Helpers.LookaheadHelpers, only: [opens_inline_code: 1, still_inline_code: 2, read_list_lines: 3]
  import Monocle.Helpers.LineHelpers
  import Monocle.Helpers.AttrParser
  import Monocle.Helpers.ReparseHelpers
  import Monocle.Message, only: [add_message: 2, add_messages: 2]
  ...
  @spec _parse(Line.ts, ts, Options.t) :: {ts, Monocle.Message.ts}
