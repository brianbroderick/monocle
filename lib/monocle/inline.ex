 defmodule Monocle.Inline do
  ...
  alias  Monocle.Error
  alias  Monocle.Helpers.LinkParser
  import Monocle.Helpers
  import Monocle.Helpers.StringHelpers, only: [behead: 2]
  import Monocle.Helpers.HtmlHelpers, only: [augment_tag_with_ial: 4]
  import Monocle.Context, only: [prepend: 2, set_value: 2]
