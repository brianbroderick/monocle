defmodule Monocle.HtmlRenderer do

  alias  Monocle.Block
  alias  Monocle.Context
  alias  Monocle.Options
  import Monocle.Inline,  only: [ convert: 3 ]
  import Monocle.Helpers, only: [ escape: 2 ]
  import Monocle.Helpers.HtmlHelpers
  import Monocle.Message, only: [ add_messages_from: 2, add_messages: 2, get_messages: 1 ]
  import Monocle.Context, only: [ append: 2, set_value: 2 ]
