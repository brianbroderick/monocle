defmodule Monocle.Parser do

  alias Monocle.Line
  alias Monocle.Block
  import Monocle.Message, only: [add_messages: 2]


  @spec parse(list(String.t), %Monocle.Options{}, boolean) :: {Block.ts(), %{}}
  def parse(text_lines), do: parse(text_lines, %Monocle.Options{}, false)

  def parse(text_lines, options = %Monocle.Options{}, recursive) do
    [ "" | text_lines ++ [""] ]
  ...
  # @spec handle_footnotes( Block.ts, %Monocle.Options{}, ( Block.ts,
  ...
  @spec get_footnote_numbers( list({String.t, number()} ), Block.ts, %Monocle.Options{} ) :: Block.ts
